...
const NAME_STOP = /(?:^|\s)(?:في|من|عن|حين|لما|يصف|يمدح|يرثي|وهو|وهي|رحمه|رضي|قوله|أيضا|وقد|إذ|والله|أعلم|اعلم|تعالى|عليه|وقيل|ولعله|أظن|اظن|على|وكان|كان|وكانت|يقول|أنشد|حيث|ثم|فلما|لمّا)(?:\s|$)/;
